...
<div class="container mt-3 mb-3">
    <form onsubmit="return validasi()" id="myForm" action="../mod/pendaftaran/pendaftaran.php" method="POST">
        <div class="card">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col">
                                    ...
                                    <input type="number" class="form-control" id="jumlah_saudara" name="jumlah_saudara"
                                        placeholder="Jumlah Saudara" oninput="numberInput(this)">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="kk" name="kk" placeholder="Masukkan Nomor KK"
                                oninput="numberInput(this)">
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                ...
                                <input type="number" class="form-control" id="bulan_lahir_ayah" name="bulan_lahir_ayah"
                                    placeholder="Bulan" oninput="numberBulan(this)">
                            </div>
                            <div class="col">
                                <label for="tahun_lahir_ayah" class="form-label">Tahun</label>
                                <input type="number" class="form-control" id="tahun_lahir_ayah" name="tahun_lahir_ayah"
                                    placeholder="Tahun" oninput="numberInput(this)">
                            </div>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                ...
                                <input type="number" class="form-control" id="bulan_lahir_ibu" name="bulan_lahir_ibu"
                                    placeholder="Bulan" oninput="numberBulan(this)">
                            </div>
                            <div class="col">
                                <label for="tahun_lahir_ibu" class="form-label">Tahun</label>
                                <input type="number" class="form-control" id="tahun_lahir_ibu" name="tahun_lahir_ibu"
                                    placeholder="Tahun" oninput="numberInput(this)">
                            </div>
                        </div>
                        <div class="mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" class="form-control" id="no_hp" name="no_hp" placeholder="Masukkan No HP"
                                oninput="numberInput(this)">
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function printPage(id) {
        ...
        printFrame.src = 'cetakform' + "?id=" + id;
